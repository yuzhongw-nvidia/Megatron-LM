...
class ModelParallelConfig:
    ...
    the TP sum completes, then cast back to BF16. Native column input gradients also use
    bounded FP32 contraction tiles at TP1. Requires TE's matching opt-in interface;
