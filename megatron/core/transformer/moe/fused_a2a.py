...
class HybridEPDispatch(torch.autograd.Function):
    ...
    def forward(
        ...
        if _hybrid_ep_buffer is None:
            ...
            # Experimental long-context probe: allow DeepEP to exercise its
            # native failure/splitting behavior past the conservative QP-depth
            # guard. Re-enable this before any production/upstream use.
