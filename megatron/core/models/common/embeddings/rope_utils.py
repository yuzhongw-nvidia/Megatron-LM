...
def _apply_rotary_pos_emb_thd(
    ...
    Args:
        ...
        cp_partition_mode: Concrete context-parallel layout, ``"zigzag"`` or ``"contiguous"``.
...
def apply_rotary_pos_emb(
    ...
    ``cp_partition_mode`` describes the current concrete tensor layout under
    context parallelism. It must be ``"zigzag"`` or ``"contiguous"`` for THD CP.
    """
