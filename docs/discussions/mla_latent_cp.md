...
attention are then submitted in order on that same stream. This removes a third projection stream
and the projection-ready record/wait chain without moving the next P2P launch ahead of current
attention. The strict host enqueue order remains
